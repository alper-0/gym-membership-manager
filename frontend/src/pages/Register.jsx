...
import { Heart, Mail, Lock, User, Phone, AlertCircle, Loader, CheckCircle } from 'lucide-react';
      ...
      <div className="relative w-full max-w-2xl">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">
            Join <span className="text-green-500">VitalFit</span>
          </h1>
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 border-4 border-green-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="p-4 bg-green-50 rounded-xl border-2 border-green-200">
              <p className="text-xs font-semibold text-green-700 mb-2">Password must contain:</p>
